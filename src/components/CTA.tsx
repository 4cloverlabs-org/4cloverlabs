      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          <motion.h2 
            ...
            className="text-[clamp(2.2rem,5vw,4.5rem)] font-bold text-white leading-[1.1] tracking-tight max-w-[800px]"
          >
          ...
          <motion.p 
            ...
            className="font-sans text-base md:text-xl text-white/90 font-medium leading-relaxed max-w-[650px] mb-4"
          >
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full sm:w-auto mt-2"
          >
            <Link
              href="/contact"
